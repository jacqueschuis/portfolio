...
subtitle: Build a beautiful Next JS dev portfolio
...
isFeaturable: false
featureImage: "/blog/posts/refactoring-your-portfolio/portfolio.png"
---

A portfolio is a major milestone in any developer's career. For me, it was set to be the last thing I made before I applied to jobs. I, like many others, placed a lot of weight on the success of my portfolio. It was, after all, supposed to be me as a developer and designer made manifest for all to see.

With such high-stakes, though, it is important that you don't let the importance cloud your judgement. Your portfolio itself, like any of the projects which it contains, is a project that needs to be executed well. You will need to iterate and make multiple versions, and your first variation likely will not be the one to stick around.

Here was my first attempt at my portfolio:

<ArticleImage
  src="/blog/posts/refactoring-your-portfolio/portfolio-full-v1.png"
  alt="Full length of original portfolio"
  imageClass="w-full"
  parentClass="max-h-[300px] xl:max-h-[500px] overflow-y-auto"
/>
...
I made some not-so-great decisions when I was developing my portfolio that, if I could go back, I would definitely have done differently. I spoke about some of these in the Readme on [my portfolio's GitHub repo](https://github.com/jacqueschuis/portfolio/blob/main/README.md)
