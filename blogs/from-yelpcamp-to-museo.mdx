...
I'm a graphic designer by trade, and this has been a curse and a blessing. My expectations for the UI of my apps are often much higher than my technical skills would allow, and this was particularly frustrating earlier on.

Luckily, I was able to find libraries to help, and I relied on MasonryJS for index layouts. I still had to further complicate things (naturally) by adding decently complex custom CSS for hover states.
...
While shifting themes might be enough to convince a layperson that your app is brand new and completely original, you will have to change things even more if you want to convince a hiring manager who is reviewing your portfolio.
...
Similarly, I wanted users to be able to filter. Filtering was easy for both artworks and museums, but for the artists, it was very difficult for me to implement.

One of the biggest roadblocks came from how I structured my data: if an artist was still living, they still had a `deathDate` on their document, but it was `null`. To get around this, I ended up having to build out my JS form handler to selectively require/disable different parts of the form:
