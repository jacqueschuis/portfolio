...
const FrontEndMentorEntry = ({name, screenshot,repo,liveSite,challenge,description,summary, tools}) => {
    ...
    const classes = visible ? "rotate-0 transition-all hover:text-orange-light cursor-pointer" : "rotate-180 transition-all hover:text-orange-light cursor-pointer"
        ...
        return (
            <div className="rounded-3xl shadow-lg box-border p-10 mb-5 break-inside-avoid-column flex flex-col">
                <div className="flex justify-between items-center relative">
                    <h3 onClick={() => setVisible(!visible)} className="w-3/4 transition-all cursor-pointer text-2xl font-bold mb-2 hover:text-blue-light">{name}</h3>
