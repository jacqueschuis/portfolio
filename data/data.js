...
import cssIllustration from '/images/cssIllustrationLandingPage.png'
...
module.exports.frontEndMentor = [
    {
        ...
        description: ["Tip calculator with custom validation and error handling", "Responsive design through CSS flexbox and grid", "Live-updating results through custom event handlers"],
        tools: ["HTML", "CSS", "JS"],
    }, 
    {
        ...
        description: ["Responsive landing page design written completely with vanilla CSS", "Extensive usage of 'calc( )' and CSS flexbox for responsive sizing"],
        tools: ["HTML", "CSS", "JS"]
    }, 
    {
        name: "Age Calculator",
        ...
        description: ["Responsive age calculator widget with custom data validation and error handling"],
        tools: ["HTML", "CSS", "JS"]
    }, 
]